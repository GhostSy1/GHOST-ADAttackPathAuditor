...
RULES = [('AD-DELEGATION', 'unconstrained delegation|constrained delegation|rbcd|trustedfordelegation'), ('AD-ACCOUNT', 'adminCount=1|domain admins|enterprise admins|krbtgt|as-rep-roastable|kerberoastable'), ('AD-TRUST', 'external trust|forest trust|sid-history|selective authentication')]
